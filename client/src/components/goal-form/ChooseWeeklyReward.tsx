...
import { RootState, setWeeklyReward } from '../../redux'
...
const ChooseWeeklyReward = () => {
  ...
  const weeklyReward = useSelector(
    (state: RootState) => state.goalForm.weeklyReward
  )
    ...
    <div className={classes.container}>
      <FormControl component="fieldset" className={classes.formControl}>
        ...
        <RadioGroup
          ...
          onChange={e =>
            dispatch(
              setWeeklyReward(e.target.value.toLowerCase() as keyof DaysOfWeek)
            )
          }
